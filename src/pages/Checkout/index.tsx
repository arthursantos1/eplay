        ...
        <Card title="Muito obrigado">
          <>
            ...
            <p className="margin-top">
              ...
              que a confirmação pode levar até 3 dias úteis. Após a aprovação
              aprovação pagamento, enviaremos um e-mail contendo o código de
              ativação do jogo.
            </p>
            <p className="margin-top">
              ...
              <div className="margin-top">
                {payWithCard ? (
                  ...
                  <p>
                    ...
                    jogo adquirido ocorrerá somente após a pagamento do boleto.
                  </p>
                )}
              </div>
            </>
